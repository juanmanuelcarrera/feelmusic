...
class PrototypeContainer extends Component {
  ...
  _renderPauseButton(onPress, active) {
    ...
    var name = title == "RESUME" ? "play" : "pause";
    return (
      <Button onPress={onPress}>
        <Icon name={name} />
        <Text style={style}>{title}</Text>
  ...
  componentWillMount() {
    ...
    accelerationObservable.subscribe(acceleration => {
      ...
      if (Platform.OS === "ios") {
        ...
        if (
          acceleration.z > -0.7 &&
          (acceleration.x > -0.2 && acceleration.x < 0.2)
        )
          this.setState({ cont: "no" });
        if (acceleration.x < -0.7) {
          this.setState({ cont: "ok" });
          if (this.state.bucle == 0) this.state.bucle = 1;
          else if (this.state.bucle == 1) {
            this.state.bucle = 2;
          }
        } else if (acceleration.x > 0.7) {
          this.setState({ cont: "ok" });
          if (this.state.sonido == 0) this.state.sonido = 1;
        } else if (acceleration.x < 0.7) {
          //this.setState({ cont: 'no' });
          if (this.state.sonido == 1) this.state.sonido = 0;
        }
      } else {
        if (acceleration.z > 7)
          //reproducir sonido
    ...
    if (this.state.out == 0) {
      if (this.state.cuadricula == 0) {
        if (this.state.cont == "ok") {
          ...
          if (this.state.bucle >= 1) this.state.bucle = 0;
          if (this.state.sonido == 1) this.state.sonido = 0;
        }
      }
    ...
    return (
      <Container>
        ...
        <Footer>
          <FooterTab>
            <Button
              active={this.state.cuadricula == 0}
              onPress={() => {
                this.tabView.goToPage(0);
                this.setState({ cuadricula: 0 });
              }}
            >
              <Text>One</Text>
            </Button>
            <Button
              active={this.state.cuadricula == 1}
              onPress={() => {
                this.tabView.goToPage(1);
                this.setState({ cuadricula: 1 });
              }}
            >
              <Text>Two</Text>
            </Button>
...
var sound10 = new Sound(require("./../samples/sample5.wav"), error => {
  //aqui va el sample6
  if (error) {
    console.log("error occured", error);
  }
...
var sound11 = new Sound(require("./../samples/sample5.wav"), error => {
  //aqui va el sample7
  if (error) {
    console.log("error occured", error);
  }
...
var sound12 = new Sound(require("./../samples/sample5.wav"), error => {
  //aqui va el sample8
  if (error) {
    console.log("error occured", error);
  }
...
var sound14 = new Sound(require("./../samples/sample5.wav"), error => {
  //aqui va el sample6
  if (error) {
    console.log("error occured", error);
  }
...
var sound15 = new Sound(require("./../samples/sample5.wav"), error => {
  //aqui va el sample7
  if (error) {
    console.log("error occured", error);
  }
...
var sound16 = new Sound(require("./../samples/sample5.wav"), error => {
  //aqui va el sample8
  if (error) {
    console.log("error occured", error);
  }
